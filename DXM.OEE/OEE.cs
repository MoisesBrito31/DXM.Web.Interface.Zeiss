...
namespace DXM.OEE
{
    public class OEE
    {
        ...
        public bool[] zerou_turno { get; set; } = { false, false, false };
        ...
        public OEE(int _linhas, List<Linha> ls, string _endereco, int _emulador, int _tickLog, bool[] _zerou_turno1)
        {
            zerou_turno = _zerou_turno1;
            Linhas = ls;
            quantidade = _linhas;
            DXM_Endress = _endereco;
            emulador = _emulador;
